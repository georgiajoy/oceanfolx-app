...
DROP POLICY IF EXISTS "Employees and admins can insert eligible staff attendance" ON session_staff_attendance;
DROP POLICY IF EXISTS "Employees and admins can read all user_roles" ON user_roles;
