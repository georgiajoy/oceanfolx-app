...
import { Award, Calendar, LayoutDashboard, LogOut, BookOpen, Menu } from 'lucide-react';

function ParticipantLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    { href: '/participant', icon: LayoutDashboard, label: t('dashboard') },
    { href: '/participant/lessons', icon: BookOpen, label: t('lessons') },
    { href: '/participant/progress', icon: Award, label: t('progress') },
    { href: '/participant/attendance', icon: Calendar, label: t('attendance') },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E8F8FA] to-[#F5F5F5]">
      <nav className="bg-gradient-to-r from-[#443837] to-[#5A4A47] shadow-lg relative z-50">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="hidden sm:block">
                <LanguageSwitcher currentLanguage={language} onLanguageChange={updateLanguage} />
              </div>
              <Button
                size="sm"
