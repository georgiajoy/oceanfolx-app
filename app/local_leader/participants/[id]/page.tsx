...
export default function LocalLeaderParticipantDetailPage({ params }: { params: { id: string } }) {
  ...
  const [localLeaderId, setAdminId] = useState<string>('');
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          validated_by_volunteer_id: localLeaderId,
